...
namespace mamba
{
    static fs::path PREFIX_STATE_FILE = fs::path("conda-meta") / "state";
    static fs::path PACKAGE_ENV_VARS_DIR = fs::path("etc") / "conda" / "env_vars.d";
    static std::string CONDA_ENV_VARS_UNSET_VAR = "***unset***";
    ...
    public:
        ...
        auto build_activate(const fs::path& prefix)
        {
            EnvironmentTransform envt;
