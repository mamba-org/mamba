...
namespace mamba
{
    ...
    inline MProblemsGraphs::MProblemsGraphs(MPool* pool)
        : m_pool(pool)
    {
    }
    ...
    inline MProblemsGraphs::merged_conflict_graph MProblemsGraphs::create_graph(
        const std::vector<MSolverProblem>& problems)
    {
    ...
    inline void MProblemsGraphs::add_solvables_to_conflicts(node_id source_node,
                                                            node_id target_node)
    {
            ...
            for (size_t i = 0; i < hash_to_nodes.second.size(); ++i)
            {
                ...
                for (size_t j = i + 1; j < hash_to_nodes.second.size(); ++j)
                {
                    ...
                    */
                    ...
                    {
                        std::cerr << "connected " << id_i << "(" << maybe_package_name_i.value()
    ...
    inline std::unordered_map<MProblemsGraphs::node_id, MProblemsGraphs::group_node_id>
