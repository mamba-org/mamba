...
#include "problems_graph_creator.hpp"
#include "problems_graph_merger.hpp"
...
namespace mamba
{
    ...
    public:
        ...
        std::string explain_problems(const std::vector<std::string>& requested_jobs);
    ...
    private:
        ...
        Pool* m_pool;
        Queue m_jobs;
        MProblemsGraphCreator m_graph_creator;
    };
}  // namespace mamba
