...
namespace std
{
    ...
    template <>
    struct hash<::resolvo::VersionSetUnionId>
    {
        size_t operator()(const ::resolvo::VersionSetUnionId& id) const noexcept
        {
            return static_cast<size_t>(id.id);
        }
    };
    ...
    {
        size_t operator()(const ::resolvo::ConditionId& id) const noexcept
        {
            return static_cast<size_t>(id.id);
        }
    };
