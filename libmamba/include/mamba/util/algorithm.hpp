...
namespace mamba::stdext // not using mamba::util because of potential conflicts with existing tooling
{
    ///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    namespace details
    {
        struct contains_fn
        {
            ...
            {
                return std::ranges::find(std::ranges::begin(r),
                                    std::ranges::end(r), value, proj) != std::ranges::end(r);
            }
        };
    }
