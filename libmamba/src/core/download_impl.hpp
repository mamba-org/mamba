...
namespace mamba
{
    ...
    public:
        ...
        void prepare_download(CURLMultiHandle& downloader,
    ...
    private:
        ...
        static int curl_progress_callback(void* f, curl_off_t total_to_download, curl_off_t now_downloaded, curl_off_t, curl_off_t);
    ...
    public:
        ...
        auto prepare_new_attempt(CURLMultiHandle& handle,
                                 const Context& context) -> completion_map_entry;
    ...
    public:
        ...
        explicit Downloader(MultiDownloadRequest requests,
