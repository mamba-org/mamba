...
namespace mamba
{
    ...
    ************************/
    ...
    MProblemsGraphs::MProblemsGraphs(int a) {}
    ...
    void MProblemsGraphs::create_initial_graph(MPool* pool, const std::vector<MSolverProblem>& problems) 
    {
    ...
    void MProblemsGraphs::add_problem_to_graph(MPool* pool, const MSolverProblem& problem) 
    {
        switch (problem.type) 
        {
    ...
    const Union<MProblemsGraphs::node_id>& MProblemsGraphs::create_unions() 
    {
