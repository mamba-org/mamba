...
namespace mamba
{
                               ...
                               const fs::u8path& mamba_exe)
    {
        ...
        content << "eval \"$('$MAMBA_EXE' shell hook --shell " << shell << " --prefix '$MAMBA_ROOT_PREFIX')\"\n";
        ...
        content << "__mamba_setup=\"$('$MAMBA_EXE' shell hook --shell " << shell << " --prefix '$MAMBA_ROOT_PREFIX'" << " 2> /dev/null)\"\n";
