...
namespace mamba
{
    ...
    namespace
    {
        ...
        {
            auto prefix = fs::u8path(mamba::util::expand_home(candidate.string()));
            ...
            return expected_t<fs::u8path>(fs::weakly_canonical(std::move(prefix)));
        }
        ...
        // get_root_prefix implementation - needs to be in anonymous namespace to access validate_*
        // functions
        auto get_root_prefix_impl() -> fs::u8path
        {
