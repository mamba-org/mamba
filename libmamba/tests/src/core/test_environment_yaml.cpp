...
namespace mamba
{
    namespace
    {
        ...
        TEST_CASE("prefix_to_yaml_contents: basic conversion", "[api][environment-yaml]")
        {
            ...
            auto yaml_contents = prefix_to_yaml_contents(prefix_data, ctx, "test_env", false, false);
        ...
        TEST_CASE("prefix_to_yaml_contents: with environment variables", "[api][environment-yaml]")
        {
            ...
            auto yaml_contents = prefix_to_yaml_contents(prefix_data, ctx, "", false, false);
        ...
        TEST_CASE("prefix_to_yaml_contents: no_builds option", "[api][environment-yaml]")
        {
            ...
            auto yaml_contents = prefix_to_yaml_contents(prefix_data, ctx, "", true, false);
        ...
        TEST_CASE("prefix_to_yaml_contents: ignore_channels option", "[api][environment-yaml]")
        {
            ...
            auto yaml_contents = prefix_to_yaml_contents(prefix_data, ctx, "", false, true);
