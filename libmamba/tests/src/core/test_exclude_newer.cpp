...
using detail::seconds_per_day;
using detail::seconds_per_hour;
using detail::seconds_per_minute;
using detail::seconds_per_month;
using detail::seconds_per_week;
using detail::seconds_per_year;
