...
namespace mamba
{
    namespace
    {
        ...
        {
            auto random_path = get_python_noarch_target_path("some_lib/some_folder", "bla").string();
            ...
            auto ps_path = get_python_noarch_target_path(
                               ...
                               .string();
#ifdef _WIN32
            REQUIRE(random_path == "some_lib\\some_folder");
            REQUIRE(sp_path == "target_site_packages_short_path\\some_random_package");
            REQUIRE(ps_path == "Scripts\\some_random_file");
#else
            REQUIRE(random_path == "some_lib/some_folder");
            REQUIRE(sp_path == "target_site_packages_short_path/some_random_package");
            REQUIRE(ps_path == "bin/some_random_file");
#endif
        }
    }
