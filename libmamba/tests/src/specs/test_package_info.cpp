...
TEST_CASE("PackageInfo serialization")
{
    ...
    SECTION("field")
    {
        ...
        REQUIRE(
            pkg.field("package_url") == "https://repo.mamba.pm/conda-forge/linux-64/foo-4.0-mybld.conda"
        );
    ...
    SECTION("to_json")
    {
        ...
        REQUIRE(j.at("sha256") == "01ba4719c80b6fe911b091a7c05124b64eeece964e09c058ef8f9805daca546b");
        REQUIRE(
            j.at("signatures")
