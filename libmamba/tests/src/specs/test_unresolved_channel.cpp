...
TEST_CASE("Parsing")
{
    ...
    {
        const auto uc = UnresolvedChannel::parse("https://repo.anaconda.com/conda-forge/osx-64").value();
        REQUIRE(uc.type() == Type::URL);
        REQUIRE(uc.location() == "https://repo.anaconda.com/conda-forge");
    ...
    {
        const auto uc = UnresolvedChannel::parse("https://repo.anaconda.com/conda-forge[win-64|noarch]")
                            .value();
        REQUIRE(uc.type() == Type::URL);
        REQUIRE(uc.location() == "https://repo.anaconda.com/conda-forge");
    ...
    SECTION("https://repo.anaconda.com/conda-forge/linux-64/pkg-0.0-bld.conda")
    {
        ...
        REQUIRE(uc.location() == "https://repo.anaconda.com/conda-forge/linux-64/pkg-0.0-bld.conda");
        REQUIRE(uc.platform_filters() == PlatformSet{});
    }
