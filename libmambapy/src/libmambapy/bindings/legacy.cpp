...
bind_submodule_impl(pybind11::module_ m)
{
    ...
    pyPackageInfo  //
        ...
        .def_property("version", &PackageInfo::version, &PackageInfo::set_version)
        .def_property("build_string", &PackageInfo::build_string, &PackageInfo::set_build_string)
        .def_property("build_number", &PackageInfo::build_number, &PackageInfo::set_build_number)
        .def_property("noarch", &PackageInfo::noarch, &PackageInfo::set_noarch)
