...
def init_api_context(use_mamba_experimental=False):
    ...
    api_ctx.output_info.json = context.json
    ...
    api_ctx.output_info.verbosity = context.verbosity
    api_ctx.set_verbosity(context.verbosity)
    api_ctx.output_info.quiet = context.quiet
    ...
    if context.ssl_verify is False:
        api_ctx.remote_fetch_info.ssl_verify = "<false>"
    elif context.ssl_verify is not True:
        api_ctx.remote_fetch_info.ssl_verify = context.ssl_verify
    ...
    api_ctx.remote_fetch_info.connect_timeout_secs = int(
        round(context.remote_connect_timeout_secs)
    )
    api_ctx.remote_fetch_info.max_retries = context.remote_max_retries
    api_ctx.remote_fetch_info.retry_backoff = context.remote_backoff_factor
