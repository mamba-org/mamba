...
def test_list_export(
    tmp_home, tmp_root_prefix, tmp_env_name, tmp_xtensor_env, env_selector, export_flag
):
    if env_selector == "prefix":
        res = helpers.umamba_list("-p", tmp_xtensor_env, export_flag)
    elif env_selector == "name":
        res = helpers.umamba_list("-n", tmp_env_name, export_flag)
    else:
        res = helpers.umamba_list(export_flag)
